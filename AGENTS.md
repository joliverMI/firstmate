...
state/               runtime records and signals; gitignored
  ...
  handoff-cards/     private "<item-key><TAB><card-id>" pairings recording which Fleet Dashboard card each item handed off to a secondmate serves; written only by bin/fm-backlog-handoff.sh --card once staging lands, consumed the moment arrival is confirmed (docs/dashboard.md "The mechanical card link")
