...
test_send_refuses_and_admits() {
  ...
  assert_contains "$(cat "$log")" "target=@1 literal=1 arg=Firstmate instruction waiting" \
    "send: normal steer should ring the durable inbox doorbell at the recorded window's own resolved id"
