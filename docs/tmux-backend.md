...
None of these license recovery or deliver input the way the six gated primitives above do, so they remain a reported, not-yet-fixed gap rather than a closed one.
