...
#   - Need: arms only while fm_supervision_needed (bin/fm-supervision-lib.sh)
#     still reports something to supervise; docs/turnend-guard.md's "Guard
#     predicates" owns that input list. An idle home exits 0.
