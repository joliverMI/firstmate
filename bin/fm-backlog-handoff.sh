...
if [ "${#TO_MOVE[@]}" -eq 0 ]; then
  ...
  # against it. It is recorded BEFORE the receiver wake, which exits on
  # failure: a wake that cannot be delivered must not also discard the
  # statement of which card this item serves.
